...
public class Message {
    ...
    public Message(String id, String text, String fromID, ArrayList<String> toID, Long timestamp) {
        this.id = id;
        this.text = text;
        this.fromID = fromID;
        this.toID = toID;
    ...
    public static ArrayList<Message> convertFirebaseMessages(List<DocumentSnapshot> messageList) {
        ...
        for (DocumentSnapshot currMessage : messageList) {
            messages.add(new Message(currMessage.getString("id"), currMessage.getString("text"),
                    currMessage.getString("fromID"), (ArrayList<String>)currMessage.get("toID"),
                    currMessage.getLong("timestamp")));
        }
        return messages;
    }
